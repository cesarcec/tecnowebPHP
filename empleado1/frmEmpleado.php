...
<body style="background-color: #CEE3F6;">
    <div id="wrapper" style="width: 700px; margin: 20px auto; border: 1px solid #ccc; padding: 20px; background-color: #FFF;">
        ...
        <form id="form1" name="form1" method="post" action="frmEmpleado.php">
            <table width="690" border="0">
                ...
                <tr>
                    <td>Estado Civil</td>
                    <td>
                        <?php $est = isset($_GET['pestado']) ? htmlspecialchars($_GET['pestado']) : 'soltero'; ?>
                ...
                <tr>
                    <td>Categoria</td>
                    <td>
                        <?php $cat = isset($_GET['pcategoria']) ? htmlspecialchars($_GET['pcategoria']) : 'A'; ?>
                ...
                <tr>
                    <td>Fecha Ingreso</td>
                    <td>
                        <?php $fec = isset($_GET['pfecha_ing']) ? htmlspecialchars($_GET['pfecha_ing']) : date('Y-m-d'); ?>
                ...
                <tr>
                    <td>Activo</td>
                    <td>
                        <?php $act = isset($_GET['pactivo']) ? htmlspecialchars($_GET['pactivo']) : '0'; ?>
        ...
        {
            $obj = new Empleado();
            $chkNom = isset($_POST['chkNom']) ? htmlspecialchars($_POST['tnombre']) : '';
            $chkPat = isset($_POST['chkPat']) ? htmlspecialchars($_POST['tpaterno']) : '';
            $chkCat = isset($_POST['chkCat']) ? htmlspecialchars($_POST['tcategoria']) : '';
        ...
        {
            echo "<table border='2'>";
            echo "<tr><td>Codigo</td><td>Nombre</td><td>Paterno</td><td>Materno</td><td>Estado Civil</td><td>Categoria</td><td>Fecha Ingreso</td><td>Activo</td><td>*</td></tr>";
        ...
        if (isset($_POST['botones'])) {
            switch ($_POST['botones']) {
                case "Nuevo":
                    // No action needed for "Nuevo" in this case
                    break;
                case "Guardar":
                    guardar();
                    break;
