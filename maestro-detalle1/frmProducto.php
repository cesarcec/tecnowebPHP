...
<body>
	...
	<center>
			...
			<fieldset id="form">
				...
				<table width="325" border="0">
					<tr>
						...
						<td>
							<?php
							if (isset($_GET['pid_producto']))
								$cod = $_GET['pid_producto'];
							?>
							<input name="txtIdProducto" type="text" value="<?php if(isset($_GET['pid_prodcuto'])) echo $cod; ?>" id="txtIdProducto" />
							<label></label>
						</td>
					</tr>
					<tr>
						...
						<td width="253"><label>
								<?php
								if (isset($_GET['pdescripcion']))
									$des = $_GET['pdescripcion'];
								?>
								<input name="txtDescripcion" type="text" value="<?php if (isset($_GET['pdescripcion'])) {
																					echo $des;
																				} ?>" id="txtDescripcion" />
							</label></td>
					</tr>
					<tr>
						...
						<td><label>
								<?php
								if (isset($_GET['pprecio']))
									$pre = $_GET['pprecio'];
								?>
								<input name="txtPrecio" type="text" value="<?php if (isset($_GET['pprecio'])) {
																				echo $pre;
																			} ?>" id="txtPrecio" />
							</label></td>
					</tr>
					<tr>
						...
						<td><label>
								...
								?>
									<option <?php
											if (isset($_GET['pcategoria']) && $_GET['pcategoria'] == $fila['nombre']) echo "selected";
											else ?> value="<?php echo $fila['id_categoria']; ?>">
		...
		if (isset($_GET['botones']) && !$_POST['botones'])
			buscar();
