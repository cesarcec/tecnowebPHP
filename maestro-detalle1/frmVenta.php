...
if (
	isset($_POST['txtBuscarCli']) &&
	isset($_POST['txtIdCliente']) &&
	isset($_POST['txtIdVenta'])
) {
	if (!isset($_SESSION['cliente']) && isset($_GET['txtBuscarCli'])) {
		$_SESSION['cliente'] = $_POST['txtBuscarCli'];
	}
	if (!isset($_SESSION['idcliente']) && isset($_GET['txtIdCliente'])) {
		$_SESSION['idcliente'] = $_POST['txtIdCliente'];
	}
	if (!isset($_SESSION['idventa']) && isset($_GET['txtIdVenta'])) {
          ...
          <tr>
            ...
            <td>
              <?php
							...
							?>
              <input name="txtIdVenta" type="text" readonly="false" value="<?php if (isset($_SESSION["idventa"])) {
          ...
          <tr>
            ...
            <td width="253"><label>
                <?php
								...
								?>
                <input name="txtFecha" type="date" maxlength="8" size="8" value="<? echo $fecha; ?>" id="txtFecha" />
              </label>
            </td>
          </tr>
          <tr>
            ...
            <td><label>
                ...
                <input name="txtNombreCli" type="text" value="<?php if (isset($_SESSION["cliente"])) {
                ...
                <?php
								...
								?>
                <input name="txtIdCliente" type="text" readonly="true" size="3" value="<?php if (isset($_SESSION["idcliente"])) {
